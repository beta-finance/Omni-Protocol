...
// 1) forge coverage --report lcov --report-file src/tests/invariant/coverage-foundry.lcov --match-contract TestInvariantFoundry
...
// Medusa can almost always break 2 invariants within 5 minutes, often
// much faster.
//
contract TestInvariantFoundry is Test {
