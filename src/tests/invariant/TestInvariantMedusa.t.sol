...
// medusa --config src/tests/invariant/TestInvariantMedusa.json fuzz
// echidna --config src/tests/invariant/TestInvariantEchidna.yaml ./ --contract TestInvariantMedusa
//
// view html coverage reports:
// src/tests/invariant/coverage-medusa/coverage_report.html
// src/tests/invariant/coverage-echidna/covered.X.html (biggest X = latest run)
//
...
// within 2 minutes and often much faster, but in the first run can take up to 10 min
// to break both.
//
// Echidna sometimes breaks 1 invariant within 5 minutes.
// Foundry is unable to break any invariants within 5 minutes.
//
interface IHevm {
    function prank(address) external;
}

contract TestInvariantMedusa {
